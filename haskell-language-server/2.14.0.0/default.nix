...
, tasty-quickcheck, tasty-rerun, template-haskell, text, text-rope
, time, transformers, trial, unix, unliftio, unliftio-core
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    hls-graph hls-plugin-api hls-test-utils lens lsp lsp-test lsp-types
