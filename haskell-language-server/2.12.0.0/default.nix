...
, hie-bios, hiedb, hlint, hls-graph, hls-plugin-api, hls-test-utils
, implicit-hie, lens, lens-aeson, lib, list-t, lsp, lsp-test
, lsp-types, markdown-unlit, megaparsec, mod, mtl, network-uri
...
, stan, stm, stm-containers, string-interpolate, stylish-haskell
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    ghc-lib-parser-ex ghcide githash hashable hie-bios hiedb hlint
  ...
  executableHaskellDepends = [
    ...
    filepath ghc ghcide hie-bios hls-graph hls-plugin-api
    hls-test-utils lens lsp lsp-test lsp-types markdown-unlit
    optparse-applicative prettyprinter process safe-exceptions shake
    tasty-hunit text transformers unix unliftio-core
