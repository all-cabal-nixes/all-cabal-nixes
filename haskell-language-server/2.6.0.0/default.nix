...
, hls-fourmolu-plugin, hls-graph, hls-module-name-plugin
, hls-ormolu-plugin, hls-overloaded-record-dot-plugin
, hls-plugin-api, hls-pragmas-plugin
, hls-qualify-imported-names-plugin, hls-semantic-tokens-plugin
, hls-stan-plugin, hls-test-utils, lens, lens-aeson, lib, lsp
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    hls-explicit-imports-plugin hls-explicit-record-fields-plugin
    hls-fourmolu-plugin hls-graph hls-module-name-plugin
    hls-ormolu-plugin hls-overloaded-record-dot-plugin hls-plugin-api
    hls-pragmas-plugin hls-qualify-imported-names-plugin
    hls-semantic-tokens-plugin hls-stan-plugin lsp optparse-applicative
