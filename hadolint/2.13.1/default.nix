...
, hspec-discover, HsYAML, HUnit, ilist, language-docker, lib
, megaparsec, mtl, network-uri, optparse-applicative, parallel
, parsec, prettyprinter, semver, ShellCheck, silently, spdx, split
, text, time, timerep, void, xml-conduit
}:
mkDerivation {
  pname = "hadolint";
  version = "2.13.1";
  ...
  libraryHaskellDepends = [
    ...
    filepath foldl gitrev HsYAML ilist language-docker megaparsec mtl
