...
, random, regex-tdfa, rsync, SafeSemaphore, securemem, SHA
...
mkDerivation {
  ...
  executableHaskellDepends = [
    ...
    network-protocol-xmpp old-locale optparse-applicative path-pieces
    process QuickCheck random regex-tdfa SafeSemaphore securemem SHA
