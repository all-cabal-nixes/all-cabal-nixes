...
, QuickCheck, random, raw-strings-qq, rio, rio-prettyprint
, semaphore-compat, split, stm, tar, template-haskell, text, time
...
mkDerivation {
  ...
  revision = "1";
  editedCabalFile = "1qb1s220nim4kkbq1azgvhjw13w0j6cqi2gk5ijij2qm2zqjc88y";
  configureFlags = [
  ...
  libraryHaskellDepends = [
    ...
    rio-prettyprint semaphore-compat split stm tar template-haskell
  ...
  testHaskellDepends = [
    ...
    raw-strings-qq rio rio-prettyprint semaphore-compat split stm tar
