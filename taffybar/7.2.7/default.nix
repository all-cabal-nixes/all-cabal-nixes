...
, gi-gdkx113, gi-glib, gi-gobject, gi-gtk-hs, gi-gtk-layer-shell
, gi-gtk3, gi-pango, gi-wireplumber, gtk-scaling-image
...
, JuicyPixels, lib, monad-control, multimap, network
, optparse-applicative, parsec, process, QuickCheck, rate-limit
, regex-compat, safe, split, status-notifier-item, stm, systemd
...
, xml-helpers, xmonad, xmonad-contrib, yaml
}:
mkDerivation {
  pname = "taffybar";
  version = "7.2.7";
  ...
  libraryHaskellDepends = [
    ...
    gi-glib gi-gobject gi-gtk-hs gi-gtk-layer-shell gi-gtk3 gi-pango
    gi-wireplumber gtk-scaling-image gtk-sni-tray gtk-strut
    haskell-gi-base hslogger hspec HStringTemplate http-client
    http-client-tls http-conduit http-types monad-control multimap
    network parsec process QuickCheck rate-limit regex-compat safe
    split status-notifier-item stm template-haskell text time
    time-locale-compat time-units transformers tuple typed-process unix
    unliftio unliftio-core utf8-string X11 xdg-basedir
  ...
  testHaskellDepends = [
    base bytestring containers data-default dbus dbus-menu directory
    filepath gi-gtk3 hspec hspec-core hspec-golden JuicyPixels network
    QuickCheck status-notifier-item text time transformers
