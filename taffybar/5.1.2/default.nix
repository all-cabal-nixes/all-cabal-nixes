...
, directory, disk-free-space, dyre, either, enclosed-exceptions
, extra, filepath, fsnotify, gi-cairo-connector, gi-cairo-render
, gi-gdk3, gi-gdkpixbuf, gi-gdkx113, gi-glib, gi-gtk-hs
, gi-gtk-layer-shell, gi-gtk3, gi-pango, gtk-sni-tray, gtk-strut
, gtk3, haskell-gi-base, hslogger, hspec, hspec-core
, hspec-discover, hspec-golden, HStringTemplate, http-client
, http-client-tls, http-conduit, http-types, JuicyPixels, lib
, monad-control, multimap, network, optparse-applicative, parsec
, process, QuickCheck, rate-limit, regex-compat, safe, scotty
, split, status-notifier-item, stm, systemd, template-haskell, text
, time, time-locale-compat, time-units, transformers, tuple
...
mkDerivation {
  ...
  executableHaskellDepends = [
    base bytestring data-default directory filepath gi-gdk3
