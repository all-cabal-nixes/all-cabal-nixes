...
, gi-pango, gtk-scaling-image, gtk-sni-tray, gtk-strut, gtk3
, haskell-gi-base, hslogger, hspec, hspec-core, hspec-discover
, hspec-golden, HStringTemplate, http-client, http-client-tls
, http-conduit, http-types, JuicyPixels, lib, monad-control
, multimap, network, optparse-applicative, parsec, process
, QuickCheck, rate-limit, regex-compat, safe, scotty, split
, status-notifier-item, stm, systemd, template-haskell, text, time
, time-locale-compat, time-units, transformers, tuple
, typed-process, unix, unliftio, unliftio-core, utf8-string, X11
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    gi-glib gi-gtk-hs gi-gtk-layer-shell gi-gtk3 gi-pango
    gtk-scaling-image gtk-sni-tray gtk-strut haskell-gi-base hslogger
    hspec HStringTemplate http-client http-client-tls http-conduit
    http-types monad-control multimap network parsec process QuickCheck
    rate-limit regex-compat safe scotty split status-notifier-item stm
  ...
  testHaskellDepends = [
    ...
    hspec-core hspec-golden JuicyPixels network QuickCheck text
