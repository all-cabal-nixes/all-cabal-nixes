...
mkDerivation {
  ...
  testHaskellDepends = [
    base bytestring containers data-default dbus directory filepath
    gi-gtk3 hspec hspec-core hspec-golden JuicyPixels network
    QuickCheck status-notifier-item text transformers typed-process
    unix unliftio
  ];
