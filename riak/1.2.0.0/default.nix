...
, hashable, HUnit, lib, mersenne-random-pure64, microlens
, monad-control, mtl, network, process, proto-lens, pureMD5
, QuickCheck, random, resource-pool, riak-protobuf, semigroups, stm
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    monad-control network proto-lens pureMD5 random resource-pool
    riak-protobuf semigroups stm text time transformers
    transformers-base unordered-containers vector
  ];
  testHaskellDepends = [
    aeson base bytestring containers data-default-class HUnit microlens
    mtl process QuickCheck riak-protobuf semigroups tasty tasty-hunit
