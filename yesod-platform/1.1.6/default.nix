...
, case-insensitive, cereal, certificate, classy-prelude
, classy-prelude-conduit, clientsession, conduit, cookie, cprng-aes
, cpu, crypto-api, crypto-conduit, crypto-pubkey-types
, crypto-random-api, cryptocipher, cryptohash, css-text
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    certificate classy-prelude classy-prelude-conduit clientsession
    conduit cookie cprng-aes cpu crypto-api crypto-conduit
    crypto-pubkey-types crypto-random-api cryptocipher cryptohash
    ...
    language-javascript largeword lifted-base mime-mail mime-types
    ...
    primitive project-template pureMD5 pwstore-fast ranges ReadArgs
