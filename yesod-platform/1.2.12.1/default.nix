...
, cipher-des, cipher-rc4, clientsession, conduit, conduit-extra
, connection, cookie, cprng-aes, crypto-api, crypto-cipher-types
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    case-insensitive cereal cipher-aes cipher-des cipher-rc4
