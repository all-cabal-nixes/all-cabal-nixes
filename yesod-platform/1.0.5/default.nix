...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    wai-app-static wai-extra wai-logger wai-test warp xml-conduit
    xml-types xml2html xss-sanitize yaml yesod yesod-auth yesod-core
    yesod-default yesod-form yesod-json yesod-persistent yesod-routes
    yesod-static yesod-test zlib zlib-bindings zlib-conduit
  ];
