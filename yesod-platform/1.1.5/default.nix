...
, base64-bytestring, basic-prelude, blaze-builder
...
, cryptocipher, cryptohash, css-text, data-default, date-cache
, dlist, email-validate, entropy, failure, fast-logger, file-embed
, filesystem-conduit, fsnotify, ghc-paths, hamlet, hashable, hjsmin
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    classy-prelude classy-prelude-conduit clientsession conduit cookie
    cprng-aes cpu crypto-api crypto-conduit crypto-pubkey-types
    cryptocipher cryptohash css-text data-default date-cache dlist
    email-validate entropy failure fast-logger file-embed
    filesystem-conduit fsnotify ghc-paths hamlet hashable hjsmin hspec
    ...
    persistent-template pool-conduit primitive project-template pureMD5
    pwstore-fast ranges ReadArgs resource-pool resourcet safe
