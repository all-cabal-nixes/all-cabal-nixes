...
, asn1-parse, asn1-types, attoparsec-conduit, authenticate, base
...
, utf8-string, void, wai, wai-app-static, wai-extra, wai-logger
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    attoparsec-conduit authenticate base base16-bytestring
    ...
    transformers-base unix-compat utf8-string void wai wai-app-static
