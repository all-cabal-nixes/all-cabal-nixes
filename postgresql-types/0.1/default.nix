...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    jsonifier mtl postgresql-libpq postgresql-types-algebra profunctors
    ptr-peeker ptr-poker QuickCheck quickcheck-extras
    quickcheck-instances scientific tagged text text-builder time
