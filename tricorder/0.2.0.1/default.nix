...
, regex-tdfa, relude, req, stm, tar, tasty, tasty-discover
, tasty-hspec, template-haskell, text, time, time-units
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    process regex-tdfa relude req stm tar template-haskell text time
