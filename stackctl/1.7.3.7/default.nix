...
, prettyprinter, QuickCheck, resourcet, rio, semigroups, text
, text-metrics, time, transformers, typed-process, unix, unliftio
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    lens-aeson monad-logger mtl optparse-applicative prettyprinter
    QuickCheck resourcet rio semigroups text text-metrics time
    transformers typed-process unix unliftio unordered-containers uuid
    yaml
  ];
