...
, conduit, containers, cookie, directory, hspec, hspec-core
, html-conduit, http-types, HUnit, lib, memory, mtl, network
, pretty-show, process, text, time, transformers, unliftio
...
mkDerivation {
  ...
  testHaskellDepends = [
    base bytestring clientsession containers cookie hspec html-conduit
    http-types HUnit text unliftio unliftio-core wai wai-extra
